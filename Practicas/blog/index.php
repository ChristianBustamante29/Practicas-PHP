...
// // Si hay algun error podemos redirigir al usuario a una paguna de error
...
// 2.- Convertimos todo el codigo en funciuones para poder reutilizarlas en la paginacion del admin
