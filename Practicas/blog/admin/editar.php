...
// Comprobamos la sesion, sino, redirigimos.
comprobarSession();


// Determinamos si se estan enviando datos por el metodo POST o GET
...
# es decir, el ID que paamos por la URL, si es asi entonces traemos los
# datos de la base de datos a pantalla para que el usuario los pueda moficar.
if ($_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    if (empty($thumb['name'])) {
        ...
        // Direccion final de archivo incluyendo el nombre
